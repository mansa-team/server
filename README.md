...
The server is structured in a way it can work natively at the machine, but its recommended that you use a Docker container, which will also be avaliable in the repository.
