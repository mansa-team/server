...
class TestDispatchRoutesMemoryTools:
    ...
    async def test_search_memory_routed_via_registry(self):
        ...
        mock_fn.assert_called_once_with(query="PETR4", user={"userId": 1}, state=None, db=None, sandbox_id=None, userId=1)
    ...
    async def test_save_memory_routed_via_registry(self):
        ...
        mock_fn.assert_called_once_with(
            key="ticker", value="PETR4", type="preference", user={"userId": 1}, state=None, db=None, sandbox_id=None, userId=1
        )
