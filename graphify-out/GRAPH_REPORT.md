# Graph Report - server  (2026-07-30)

## Corpus Check
- 88 files · ~37,057 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5066 nodes · 6837 edges · 510 communities (279 shown, 231 thin omitted)
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 1155 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a15f51a6`
...
## Communities (510 total, 231 thin omitted)
...
Cohesion: 0.06
Nodes (44): AuthenticationManager, IntFlag, Covers line 18: GET /stocks/health., Covers line 18: GET /stocks/health., Covers line 18: GET /stocks/health., Covers line 18: GET /stocks/health., Covers line 18: GET /stocks/health., Covers line 28: GET /auth/health. (+36 more)
...
Cohesion: 0.05
Nodes (40): getUserMemories(), batchCosineSimilarity(), getRelevanceScore(), _FakeMemory, A memory with no lastAccessedAt should use baseScore as-is., Scores are deterministic — no cron mutation needed., Same memory at different points in time yields different scores., A memory accessed 10x (baseScore 1.0) should still outrank         a memory acce (+32 more)
...
Cohesion: 0.12
Nodes (11): buildCotationDateIndex(), optimizeDtypes(), Get cached stocks data with optional column filtering., StocksCacheManager, Tests for dynamic ticker index feature, Ticker index should be built when cache is loaded, Ticker index should contain all tickers from cache, Ticker index should be case-insensitive (+3 more)
...
Cohesion: 0.09
Nodes (25): dispatchToolCall(), TDD tests: verify memory tools are wired into the Prometheus agent.  RED: Thes, makeChat must include MEMORY_TOOLS alongside MCP sessions., makeChat must include MEMORY_TOOLS alongside MCP sessions., makeChat must include MEMORY_TOOLS alongside MCP sessions., makeChat must include MEMORY_TOOLS alongside MCP sessions., makeChat must include MEMORY_TOOLS alongside MCP sessions., test_memory_tool_skipped_without_user() (+17 more)
...
Cohesion: 0.13
Nodes (18): applyUpdate(), archiveDead(), count_memories(), countMemories(), decayScores(), deleteMemory(), findSimilarKey(), _fulltext_search() (+10 more)
...
Cohesion: 0.29
Nodes (6): Covers lines 48-49: jwt.ExpiredSignatureError., Covers lines 45-51: verifyAccessToken with expired and invalid tokens., Covers lines 48-49: jwt.ExpiredSignatureError., Covers lines 48-49: jwt.ExpiredSignatureError., Covers lines 48-49: jwt.ExpiredSignatureError., Covers lines 48-49: jwt.ExpiredSignatureError.
...
Cohesion: 0.09
Nodes (19): getCotations(), getFundamental(), getHistorical(), listFields(), Get point-in-time fundamental/valuation data for Brazilian B3 stocks.      Ret, Get point-in-time fundamental/valuation data for Brazilian B3 stocks.      Ret, Get point-in-time fundamental/valuation data for Brazilian B3 stocks.      Ret, Get point-in-time fundamental/valuation data for Brazilian B3 stocks.      Ret (+11 more)
...
Cohesion: 0.15
Nodes (6): BaseSettings, BaseMansaSettings, DiscordSettings, MysqlSettings, StocksApiSettings, UserSettings
...
Cohesion: 0.07
Nodes (35): Base, PrometheusMemory, PrometheusMemory, MemoryManager, PrometheusMemory, All memory operations. Stateless class methods., TestDifferentKeysNoMerge, TestExactSameKeyUpdates (+27 more)
...
Cohesion: 0.27
Nodes (4): PrometheusSettings, ScraperSettings, TestSandboxConfig, TestConfig
...
Cohesion: 0.19
Nodes (15): getLiveCotation(), Get real-time price quotation for a single Brazilian B3 stock.      Returns th, Get real-time price quotation for a single Brazilian B3 stock.      Returns th, Get real-time price quotation for a single Brazilian B3 stock.      Returns th, Get real-time price quotation for a single Brazilian B3 stock.      Returns th, compactCotations(), compactRow(), compactValue() (+7 more)
...
Cohesion: 0.33
Nodes (5): Covers lines 65-67: unexpected exception., Covers lines 65-67: unexpected exception., Covers lines 65-67: unexpected exception., Covers lines 65-67: unexpected exception., Covers lines 65-67: unexpected exception.
...
Cohesion: 0.33
Nodes (5): Covers lines 34, 36-38, 40-44, 46, 48-49, 51, 58-59, 61, 63-67: UserManager.getC, Covers lines 34, 36-38, 40-44, 46, 48-49, 51, 58-59, 61, 63-67: UserManager.getC, Covers lines 34, 36-38, 40-44, 46, 48-49, 51, 58-59, 61, 63-67: UserManager.getC, Covers lines 34, 36-38, 40-44, 46, 48-49, 51, 58-59, 61, 63-67: UserManager.getC, TestGetCurrentUser
...
- **Why does `Pytest Testing` connect `Community 124` to `Authentication Core`, `Frontend Components`, `Community 129`, `Data Models & Types`, `Community 138`, `Community 140`, `Community 18`, `Community 149`, `Community 24`, `Community 25`, `Community 27`, `Community 29`, `Community 32`, `Community 33`, `Community 40`, `Community 168`, `Community 43`, `Community 44`, `Community 45`, `Community 49`, `Community 51`, `Community 54`, `Community 55`, `Community 184`, `Community 183`, `Community 59`, `Community 67`, `Community 75`, `Community 213`, `Community 216`, `Community 474`, `Community 475`, `Community 93`, `Community 221`, `Community 482`, `Community 99`, `Community 100`, `Community 486`, `Community 105`, `Community 234`, `Community 112`, `Community 120`, `Community 126`?**
  _High betweenness centrality (0.159) - this node is a cross-community bridge._
- **Why does `FastAPI` connect `Community 474` to `Community 129`, `Community 140`, `Community 18`, `Community 21`, `Community 33`, `Community 34`, `Community 37`, `Community 40`, `Community 169`, `Community 168`, `Community 43`, `Community 45`, `Community 181`, `Community 58`, `Community 189`, `Community 63`, `Community 71`, `Community 78`, `Community 81`, `Community 84`, `Community 92`, `Community 221`, `Community 482`, `Community 486`, `Community 112`, `Community 498`, `Community 120`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `UserManager` connect `Community 21` to `Prometheus Agent`, `Prometheus Memory`, `Prometheus Tools`, `User Roles & Permissions`, `Community 141`, `Community 16`, `Community 148`, `Community 22`, `Community 37`, `Community 47`, `Community 181`, `Community 56`, `Community 58`, `Community 61`, `Community 68`, `Community 211`, `Community 85`, `Community 86`, `Community 89`, `Community 221`, `Community 99`, `Community 104`, `Community 492`, `Community 110`, `Community 495`, `Community 499`, `Community 120`, `Community 122`, `Community 126`?**
