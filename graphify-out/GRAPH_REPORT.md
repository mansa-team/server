# Graph Report - server  (2026-08-11)

## Corpus Check
- 98 files · ~35,293 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5339 nodes · 7193 edges · 503 communities (279 shown, 224 thin omitted)
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 1213 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ebfbd1c5`
...
## Communities (503 total, 224 thin omitted)
...
Cohesion: 0.18
Nodes (5): createAccessToken(), hashPassword(), verifyPassword(), TestAuthUtil, TestAuthUtilEdgeCases
...
Cohesion: 0.29
Nodes (14): Base, PrometheusMemory, PrometheusMemory, PrometheusMemory, PrometheusService, TestDifferentKeysNoMerge, TestExactSameKeyUpdates, TestMergeBoostsScore (+6 more)
...
Cohesion: 0.08
Nodes (26): dispatchToolCall(), TDD tests: verify memory tools are wired into the Prometheus agent.  RED: Thes, makeChat must include MEMORY_TOOLS alongside MCP sessions., makeChat must include MEMORY_TOOLS alongside MCP sessions., makeChat must include MEMORY_TOOLS alongside MCP sessions., makeChat must include MEMORY_TOOLS alongside MCP sessions., TOOL_REGISTRY pattern must work correctly., makeChat must include MEMORY_TOOLS alongside MCP sessions. (+18 more)
...
Cohesion: 0.08
Nodes (20): generateKey(), getHistorical(), getLiveCotation(), JSONBytesResponse, Get year-based historical financial data for Brazilian B3 stocks.      Returns, Get year-based historical financial data for Brazilian B3 stocks.      Returns, Get real-time price quotation for a single Brazilian B3 stock.      Returns th, Get real-time price quotation for a single Brazilian B3 stock.      Returns th (+12 more)

### Community 82 - "Community 82"
Cohesion: 0.2
Nodes (9): _arrowTypeFor(), buildCotationDateIndex(), buildFeatherCache(), optimizeDtypes(), Get cached stocks data with optional column filtering., Map a MySQL DATA_TYPE to a pyarrow type for columns that are all-None     in th, Non-blocking cross-process lock around the feather build. Returns the lock file, tryBuildLock() (+1 more)
...
Cohesion: 0.08
Nodes (13): Pytest Testing, System prompt should instruct LLM about harness state usage., System prompt should instruct LLM about harness state usage., System prompt should instruct LLM about harness state usage., System prompt should instruct LLM about memory vs state., System prompt should instruct LLM about memory vs state., System prompt should instruct LLM about memory vs state., System prompt should instruct LLM about memory vs state. (+5 more)
...
Cohesion: 0.07
Nodes (21): Store a value in the harness state for this session. Use this to save     inter, Store a value in the harness state for this session. Use this to save     interm, Store a value in the harness state for this session. Use this to save     inter, Store a value in the harness state for this session. Use this to save     inter, Store a value in the harness state for this session. Use this to save     inter, Store a value in the harness state for this session. Use this to save     inter, set_state(), _assert_gemini_safe() (+13 more)
...
Cohesion: 0.15
Nodes (20): listFields(), Discover available field names before querying /historical or /fundamental., Discover available field names before querying /historical or /fundamental., Discover available field names before querying /historical or /fundamental., Discover available field names before querying /historical or /fundamental., Discover available field names before querying /historical or /fundamental., Discover available field names before querying /historical or /fundamental., compactCotations() (+12 more)
...
Cohesion: 0.12
Nodes (9): dispatchToolCall must route memory tool names via TOOL_REGISTRY., MEMORY_TOOLS must be defined as a Tool wrapping FunctionDeclarations., MEMORY_TOOLS must be a list of callables with proper signatures., dispatchToolCall must route memory tool names to executeMemoryTool., dispatchToolCall must route memory tool names to executeMemoryTool., dispatchToolCall must route memory tool names to executeMemoryTool., dispatchToolCall must route memory tool names to executeMemoryTool., TestDispatchRoutesMemoryTools (+1 more)
...
Cohesion: 0.12
Nodes (16): Search user's saved memories, preferences, and past analysis context.      Use t, Search user's saved memories, preferences, and past analysis context.      Use t, Search user's saved memories, preferences, and past analysis context.      Use, Search user's saved memories, preferences, and past analysis context.      Use, Search user's saved memories, preferences, and past analysis context.      Use, Search user's saved memories, preferences, and past analysis context.      Use, Search user's saved memories, preferences, and past analysis context.      Use, Store a memory about the user's preferences, analysis results, or feedback. (+8 more)

### Community 487 - "Community 487"
Cohesion: 0.1
Nodes (24): verifyAPIKey(), Tests to increase coverage for query.py, key.py, and cache.py in stocks_api., Tests covering key.py lines 15-40.     Uses asyncio.run() since pytest-asyncio, Tests covering key.py lines 15-40.     Uses asyncio.run() since pytest-asyncio, Tests covering key.py lines 15-40.     Uses asyncio.run() since pytest-asyncio, Tests covering key.py lines 15-40.     Uses asyncio.run() since pytest-asyncio, Tests covering key.py lines 48-66., Tests covering key.py lines 48-66. (+16 more)
...
Cohesion: 0.06
Nodes (27): Covers lines 13, 17, 19-20, 22-27: UserManager.addRoleToUser., Covers lines 13, 17, 19-20, 22-27: UserManager.addRoleToUser., Covers lines 17, 22-27: user found, role not present, role added., Covers lines 17, 22-27: user found, role not present, role added., Covers lines 13, 17, 19-20, 22-27: UserManager.addRoleToUser., Covers lines 17, 22-27: user found, role not present, role added., Covers lines 13, 17, 19-20, 22-27: UserManager.addRoleToUser., Covers lines 17, 22-27: user found, role not present, role added. (+19 more)
...
## Knowledge Gaps
- **2673 isolated node(s):** `$schema`, `style`, `rsc`, `tsx`, `config` (+2668 more)
...
- **Why does `Pytest Testing` connect `Community 93` to `Authentication Core`, `Frontend Components`, `Community 131`, `Data Models & Types`, `Community 129`, `Device Detection`, `Community 137`, `Community 138`, `Community 527`, `Community 18`, `Community 147`, `Community 21`, `Community 24`, `Community 25`, `Community 27`, `Community 29`, `Community 157`, `Community 32`, `Community 33`, `Community 40`, `Community 44`, `Community 48`, `Community 49`, `Community 51`, `Community 54`, `Community 184`, `Community 59`, `Community 61`, `Community 67`, `Community 208`, `Community 214`, `Community 477`, `Community 482`, `Community 100`, `Community 102`, `Community 487`, `Community 105`, `Community 234`, `Community 115`, `Community 502`, `Community 120`, `Community 122`, `Community 126`?**
  _High betweenness centrality (0.183) - this node is a cross-community bridge._
- **Why does `FastAPI` connect `Community 157` to `Community 129`, `Community 131`, `Community 140`, `Community 18`, `Community 147`, `Community 21`, `Community 26`, `Community 33`, `Community 34`, `Community 40`, `Community 169`, `Community 43`, `Community 181`, `Community 58`, `Community 59`, `Community 63`, `Community 71`, `Community 73`, `Community 78`, `Community 81`, `Community 84`, `Community 477`, `Community 95`, `Community 482`, `Community 487`, `Community 120`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `Prometheus` connect `Community 116` to `Frontend Components`, `Device Detection`, `Community 138`, `Frontend App Shell`, `Community 151`, `Community 24`, `Community 162`, `Community 45`, `Community 49`, `Community 178`, `Community 52`, `Community 60`, `Community 61`, `Community 194`, `Community 68`, `Community 80`, `Community 87`, `Community 88`, `Community 93`, `Community 95`, `Community 105`, `Community 497`, `Community 125`?**
